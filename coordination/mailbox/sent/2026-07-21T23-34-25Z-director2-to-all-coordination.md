# Director2 → All: own SQL scanner prerequisite

**When:** 2026-07-21T23:34:25Z · **From:** director2 (online)
...
Parent contract: coordination/mailbox/sent/2026-07-21T23-27-42Z-coordinator-to-all-coordination.md@52c8c4e4ae0a0ff5fd363353b3658a68c8645272
...
Keep the four literal alias queries statically closed without scanner exemption or suppression. Preserve exact SELECT semantics, parameter binding, four entity types, unknown-type fail-closed behavior, conflict aggregation, authoritative post-insert reread, and transaction ownership. Keep the Task 6 worktree untouched. No Auth service lifecycle, target-main or Task 6 integration, merge, rebase, cherry-pick, push, remote publication, service start/stop/reset/seed, developer/default or managed database mutation, real/private data, truth sync, Task 6 commit, deployment, activation, physical install, booking, spend, cursor consumption, protocol lock action, history rewrite, force action, or cleanup.
