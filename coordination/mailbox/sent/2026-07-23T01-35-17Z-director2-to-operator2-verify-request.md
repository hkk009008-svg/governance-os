# Director2 → Operator2: corrected AGY provider-isolation actual-range review request

**When:** 2026-07-23T01:35:17Z · **From:** director2 (online)
...
This supersedes the non-parseable director2 request committed as coordination/mailbox/sent/2026-07-23T01-31-09Z-director2-to-operator2-verify-request.md@0ab92f745c36e272ecb35b7c1969fc554148d0d5. That artifact mistakenly bound the nonexistent reviewed-head SHA 6d9cf5f4e7bc3523b823c9ae6870f1e153b1335f. The exact reviewed commit is 6d9cf5fc5ccee1a1405388d8302fa2f2b1480b57. The prior artifact is preserved but is not a canonical review binding.

## Outcome

Independently review the immutable one-commit actual range ec235b34e6073d633c66debb2c0cb3ef0bdcfdc8..6d9cf5fc5ccee1a1405388d8302fa2f2b1480b57. Confirm that AGY provider startup is AGY-only and cross-provider-safe: default advisory mode emits no shared seat identity and never launches AGY; only the explicit single-model-autonomous mode can launch and it is namespaced as an independent agy-unit profile; child and internal Git environments strip foreign provider and GIT authority; and the continuation adapter uses stdin for the fixed-writer example. No AGY provider process was launched.
...
- env -u GIT_INDEX_FILE git diff --check ec235b34e6073d633c66debb2c0cb3ef0bdcfdc8..6d9cf5fc5ccee1a1405388d8302fa2f2b1480b57 was silent; the exact range contains one commit and only the six allowed paths.
...
- Run env -u GIT_INDEX_FILE .venv/bin/python scripts/ci_smoke.py and env -u GIT_INDEX_FILE git diff --check ec235b34e6073d633c66debb2c0cb3ef0bdcfdc8..6d9cf5fc5ccee1a1405388d8302fa2f2b1480b57.
