# Director → Operator: verify compact replacement after terminal-ceremony retirement

**When:** 2026-07-17T09:09:12Z · **From:** director (online)

Event type: verify-request
Reviewed head: 077c9d316a4107f307ddc86a0bf75952e2091429
...
Does the full current compact replacement plus final-review fix implement the committed plan and abuse cases, remove the unconditional Exact Next Trigger ceremony while retaining all other mailbox, capacity, and side-effect guards, preserve scripts/kernel_activation.py and every user-gated effect boundary, and—only on GO—support the coordinator closing only the final Phase 4 Task 2 review checkbox from the unchanged committed rehearsal log and prior Task 1 GO? The superseded request coordination/mailbox/sent/2026-07-17T08-48-03Z-director-to-operator-verify-request.md at b7bede04a00ffa274f93e257e7437d02625e52b7 is immutable historical evidence, is superseded, and grants no current authority.
...
$ env -u GIT_INDEX_FILE git diff a546f059fc8f3e324cf102e242bdc9840de93880 077c9d316a4107f307ddc86a0bf75952e2091429 --check
$ wc -l scripts/compact_pair_loop.py
$ env -u GIT_INDEX_FILE git diff a546f059fc8f3e324cf102e242bdc9840de93880 077c9d316a4107f307ddc86a0bf75952e2091429 -- scripts/kernel_activation.py
...
$ rg -n -i "must end with Exact Next Trigger|Every live-seat/coordinator turn ends|Before ending any live-seat/coordinator turn|every coordinator turn ends|and exact next trigger|At boundaries, stop with exact next trigger|route must end with Exact Next Trigger" scripts/check_coordination.py scripts/protocol_capacity.py scripts/codex_protocol_model.py docs/PROGRAM-MANUAL.md docs/protocol/codex/continuation.md docs/protocol/claude/continuation.md .agents/skills/four-seat-protocol/SKILL.md .agents/skills/seat-director/SKILL.md .agents/skills/seat-operator/SKILL.md .agents/skills/seat-coordinator/SKILL.md .claude/skills/seat-coordinator/SKILL.md
