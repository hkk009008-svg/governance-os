...
Only an assigned distinct-seat, different-model non-author Operator issues the
verdict. The director does not self-approve. Helpers do not inherit seat or
