...
*Last verified: 2026-07-16 @ d0fc910*
...
| `adapt_v1_history` | `scripts/capability_v1_adapter.py:2187` | Strictly adapts host-normalized v1 history into reducer-accepted epoch-0 shadow envelopes. |
