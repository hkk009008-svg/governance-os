...
NOT listed in `pipeline/placeholder_allowlist.txt` and NOT under `.git/`.
...
Usage:  .venv/bin/python pipeline/check_placeholders.py   # exit 0 clean, 1 on any violation
"""
...
ALLOWLIST_FILE = ROOT / "pipeline" / "placeholder_allowlist.txt"
